...
(function(App) {
    ...
    function init() {
        try {
            ...
            // ⭐ NO auto-restaurar aquí - dejar que activate() lo maneje
            // La auto-restauración se hace solo cuando el usuario abre el focus mode manualmente
            // Esto evita doble renderización en la primera apertura
