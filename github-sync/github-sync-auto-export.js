/* ===================================
   ...
   y los muestra en el botón githubSyncBtn
   =================================== */
...
(function() {
    ...
    function init() {
        ...
        log('▶ Contador de cambios activado');
        ...
        if (savedCount) {
            ...
            log(`📊 Contador restaurado: ${changesCount} cambios pendientes`);
        }
        ...
        // Actualizar botón con el contador restaurado
        updateButton();
    ...
    function detectChanges() {
        ...
        if (currentSnapshot !== lastSnapshot) {
            ...
            log(`📝 Cambio detectado (${changesCount} cambios sin exportar)`);
            updateButton();
        }
    }
    ...
    function setupChangeDetection() {
        ...
        log('👂 Escuchando cambios de la app');
    }

    /**
     * Actualiza el botón con el contador
     */
    function updateButton() {
        ...
        // Verificar si también hay cambios remotos
    ...
    /**
     * Resetea contador después de exportar
     */
    function onExportComplete() {
        ...
        log('✅ Cambios exportados. Contador reseteado.');
        updateButton();
    }
