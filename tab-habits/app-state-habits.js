...
(function(App) {
    ...
    Object.assign(App.state, {
        ...
        updateAbstinenceChallenge: function(updatedChallenge, options = {}) {
            ...
            if (index > -1) {
                ...
                // ✅ Si es actualización automática, emitir evento diferente
        ...
        processAllChallengesOnLoad: function() {
            ...
            if (totalTicketsGenerated > 0) {
                ...
                setTimeout(() => {
                    ...
                    // ✅ CRÍTICO: Solo emitir habitsAutoUpdated (NO habitsUpdated)
                    App.events.emit("habitsAutoUpdated");
                }, 500);
            }
        },
